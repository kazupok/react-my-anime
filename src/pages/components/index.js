// components/index.js
// Text
export { default as DescriptionText } from './text/DescriptionText';
export { default as CommentText } from './text/CommentText';
// Label
export { default as IconDescriptionLabel } from './label/IconDescriptionLabel';
export { default as ReleaseYearLabel } from './label/ReleaseYearLabel';
export { default as TitleLabel } from './label/TitleLabel';
// Icon
